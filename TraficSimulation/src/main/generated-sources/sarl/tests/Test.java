...
public class Test extends Agent {
  ...
  @SyntheticMember
  public Test(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Test(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Test(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
